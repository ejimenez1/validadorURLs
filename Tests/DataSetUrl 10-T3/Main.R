...
#### Training Set Accuracy (83% for 30+ T=3)
#### Training Set Accuracy (86% for 20+ T=3) Best Combination...
#### Training Set Accuracy (94% for 10+ T=3) OVERFITTED!
#### Training Set Accuracy (80% for 30+ T=4)
...
#### Validation Set Accuracy (82% for +30 with T=3)
#### Validation Set Accuracy (83% for +20 with T=3) Best Combination...
#### Validation Set Accuracy (77% for +10 with T=3) Validation Bias!
#### Validation Set Accuracy (80% for +30 with T=4)
